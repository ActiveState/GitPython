...
from git.compat import string_types, defenc
...
class SymbolicReference(object):
    ...
    object = property(
        _get_object, set_object, doc="Return the object our ref currently refers to"
    )
            ...
            try:
                ...
                if made_change:
                    ...
                    with open(pack_file_path, "wb") as fd:
                        fd.writelines(i.encode(defenc) for i in new_lines)
